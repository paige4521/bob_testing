...
class BobTest < Minitest::Test
	...
	def test_forceful_questions #done
		remark = 'WHAT THE HELL WERE YOU THINKING?'
		assert_equal 'Whoa, chill out!', bob.hey(remark), feedback(remark)
	end

	def test_shouting_numbers #done
		remark = '1, 2, 3 GO!'
		assert_equal 'Whoa, chill out!', bob.hey(remark), feedback(remark)
	end
	...
	def test_question_with_only_numbers #done
		remark = '4?'
		assert_equal 'Sure.', bob.hey(remark), feedback(remark)
	end

	def test_shouting_with_special_characters #done
